...
*/ 
Shop.grid.OrderStatusesGrid = function(config){
    config = config || {};
    ...
    Shop.grid.OrderStatusesGrid.superclass.constructor.call(this, config);
};

Ext.extend(Shop.grid.OrderStatusesGrid, MODx.grid.Grid,{
...
Ext.reg('shop-grid-orderstatusesgrid',Shop.grid.OrderStatusesGrid);
