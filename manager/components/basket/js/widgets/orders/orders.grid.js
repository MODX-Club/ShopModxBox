...
Shop.grid.OrdersGrid = function(config){
    ...
    this._tbar.statuses = new Shop.combo.OrderStatus({
    ...
    // this._tbar.statuses = new MODx.combo.Context({
        ...
        // ,fields: ['id','fullname']
        ,url: Shop.config.connector_url + 'customers.php'
        ,baseParams: {
            action: 'getlist'
            ,show_empty_text: true
        }
...
Ext.extend(Shop.grid.OrdersGrid, MODx.grid.Grid,{
    ...
    ,addProduct: function(menu, e){
        ...
        var ProductsGrid = new Shop.grid.ProductsGrid();
...
Shop.grid.ProductsGrid = function(config){
    config = config || {}; 
    ...
    Shop.grid.ProductsGrid.superclass.constructor.call(this, config);
...
Ext.extend(Shop.grid.ProductsGrid, shopModxGroupEdit.grid.GroupEdit,{
...
Ext.reg('shop-grid-productsgrid',Shop.grid.ProductsGrid);
