...
*/
shopModxGroupEdit.grid.GroupEdit = function(config){
    config = config || {};
    ...
    Ext.applyIf(config, {
        url: shopModxGroupEdit.config.connectors_url + 'groupedit.php'
        ,title: 'Список'
        ,listType: 'documents'
        ,paging: true
        ,pageSize: 10
    ...
    shopModxGroupEdit.grid.GroupEdit.superclass.constructor.call(this, config);
    
    this.getBottomToolbar().on('change', this.onChangeBottomToolbar , this);
    
};

Ext.extend(shopModxGroupEdit.grid.GroupEdit, MODx.grid.Grid, {
