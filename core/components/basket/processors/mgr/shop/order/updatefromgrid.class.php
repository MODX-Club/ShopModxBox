...
class ShopMgrOrderUpdatefromgridProcessor extends ShopMgrOrderUpdateProcessor{ 
    ...
    public function afterSave(){
        ...
        if($this->modx->hasPermission('edit_clients_data')){
            ...
            if($orderer = $this->object->getOne('Contractor') AND $ordererProfile = $orderer->getOne('Profile')){
                $data = array(
                    'fullname' => $this->getProperty('contractor_fullname'),    
                    'email' => $this->getProperty('contractor_email'),
                    'phone' => $this->getProperty('contractor_phone'),
                );
...
return 'ShopMgrOrderUpdatefromgridProcessor';