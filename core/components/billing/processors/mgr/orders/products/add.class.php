...
class modMgrOrdersProductsAddProcessor extends modProcessor{
    ...
    public function process(){
        ...
        */
        ...
        if(!$response = $this->modx->runProcessor("mgr/orders/products/{$action}", 
            $this->getProperties(),
            array(
...
return 'modMgrOrdersProductsAddProcessor';