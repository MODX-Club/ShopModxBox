...
class Hybrid_Endpoint__ {
	...
	*/
	...
	{
		$output = file_get_contents(  Hybrid_Auth::$config['path_Hybrid'] . "resources/openid_policy.html" ); 
		print $output;
		die();
	}
	...
	*/
	public static function processOpenidRealm()
	{
		...
		(
			...
			file_get_contents( Hybrid_Auth::$config['path_Hybrid'] . "resources/openid_realm.html" )
		); 
		print $output;
		die();
	}
