...
class Hybrid_Auth 
{
	...
	*/
	public static function initialize( $config )
	{
		...
		$config["path_Hybrid"]      = $config["path_base"] . "Hybrid/";
		$config["path_libraries"]   = $config["path_Hybrid"] . "thirdparty/";
		$config["path_resources"]   = $config["path_Hybrid"] . "resources/";
		$config["path_providers"]   = $config["path_Hybrid"] . "Providers/";
		...
		require_once $config["path_Hybrid"] . "Error.php";
		//  require_once $config["path_Hybrid"] . "Logger.php";

		// require_once $config["path_Hybrid"] . "Storage.php";

		require_once $config["path_Hybrid"] . "Provider_Adapter.php";

		require_once $config["path_Hybrid"] . "Provider_Model.php";
		require_once $config["path_Hybrid"] . "Provider_Model_OpenID.php";
		require_once $config["path_Hybrid"] . "Provider_Model_OAuth1.php";
		require_once $config["path_Hybrid"] . "Provider_Model_OAuth2.php";

		require_once $config["path_Hybrid"] . "User.php";
		require_once $config["path_Hybrid"] . "User_Profile.php";
		require_once $config["path_Hybrid"] . "User_Contact.php";
		require_once $config["path_Hybrid"] . "User_Activity.php";
